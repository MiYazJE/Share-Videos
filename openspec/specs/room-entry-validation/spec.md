...
Define how the client validates room identifiers from the Join room dialog and direct room routes, including submission timing, pending state, outcomes, and failures.
