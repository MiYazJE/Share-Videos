...
const { UPDATE_ROOM, VIEW_VIDEO, NOTIFY_MESSAGE } = require('./constants');
...
const INITIAL_CURRENT_VIDEO = {
    url: 'https://www.youtube.com/watch?time_continue=136&v=Tct7AfFaR1o&feature=emb_title',
    title: 'Lost Kings - Try (Lyric Video) ft. SAFE'
};
